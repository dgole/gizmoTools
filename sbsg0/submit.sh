...
#SBATCH -N 8              # Number of nodes, not cores (16 cores/node)
#SBATCH -n 128            # Total number of MPI tasks (if omitted, n=N)
...
ibrun tacc_affinity ./GIZMO ./sbsg.params 1>gizmo.out 2>gizmo.err  
